...
public class HCatalogArrayParser implements IParser {
  ...
  public PrimitiveObject get( final int index ) throws IOException{
    return childConverter.get( record.get( index ) );
  }
  ...
  public IParser getParser( final int index ) throws IOException{
    ...
    return HCatalogParserFactory.get( childSchema , record.get( index ) );
  }
