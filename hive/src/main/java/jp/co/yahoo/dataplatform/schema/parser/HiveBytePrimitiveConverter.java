...
public class HiveBytePrimitiveConverter implements IHivePrimitiveConverter{

  private final ByteObjectInspector inspector;

  public HiveBytePrimitiveConverter( final ByteObjectInspector inspector ){
  ...
  public PrimitiveObject get(final Object target ) throws IOException{
    ...
    return new ByteObj( inspector.get( target ) );
  }
