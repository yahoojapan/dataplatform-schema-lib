...
public class HiveBytesPrimitiveConverter implements IHivePrimitiveConverter{

  private final BinaryObjectInspector inspector;
  ...
  public PrimitiveObject get(final Object target ) throws IOException{
    ...
    return new BytesObj( inspector.getPrimitiveJavaObject( target ) );
  }
