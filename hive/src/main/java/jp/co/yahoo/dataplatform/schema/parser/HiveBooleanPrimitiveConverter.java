...
public class HiveBooleanPrimitiveConverter implements IHivePrimitiveConverter{

  private final BooleanObjectInspector inspector;

  public HiveBooleanPrimitiveConverter( final BooleanObjectInspector inspector ){
  ...
  public PrimitiveObject get(final Object target ) throws IOException{
    ...
    return new BooleanObj( inspector.get( target ) );
  }
