...
public class HiveUnionSchema implements IHiveSchema {

  private final TypeInfo orcSchema;
  private final IField schema;

  public HiveUnionSchema( final UnionField schema ) throws IOException{
    this.schema = schema;

    UnionTypeInfo structSchema = new UnionTypeInfo();
    ...
    structSchema.setAllUnionObjectTypeInfos( childTypeInfo );

    orcSchema = structSchema;
  }
