...
public class HiveIntegerPrimitiveConverter implements IHivePrimitiveConverter{

  private final IntObjectInspector inspector;
  ...
  public PrimitiveObject get(final Object target ) throws IOException{
    ...
    return new IntegerObj( inspector.get( target ) );
  }
