...
public class HiveLongPrimitiveConverter implements IHivePrimitiveConverter{

  private final LongObjectInspector inspector;

  public HiveLongPrimitiveConverter( final LongObjectInspector inspector ){
  ...
  public PrimitiveObject get(final Object target ) throws IOException{
    ...
    return new LongObj( inspector.get( target ) );
  }
