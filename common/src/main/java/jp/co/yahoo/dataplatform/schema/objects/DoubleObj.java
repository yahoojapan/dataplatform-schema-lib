...
public class DoubleObj implements PrimitiveObject{
  ...
  public byte getByte() throws IOException{
    if( value < BYTE_MIN || BYTE_MAX < value ){
      throw new NumberFormatException( "Can not down cast. double to byte. double value is " + value );
    }
  ...
  public short getShort() throws IOException{
    if( value < SHORT_MIN || SHORT_MAX < value ){
      throw new NumberFormatException( "Can not down cast. double to short. double value is " + value );
    }
  ...
  public int getInt() throws IOException{
    if( value < INTEGER_MIN || INTEGER_MAX < value ){
      throw new NumberFormatException( "Can not down cast. double to integer. double value is " + value );
    }
  ...
  public long getLong() throws IOException{
    if( value < LONG_MIN || LONG_MAX < value ){
      throw new NumberFormatException( "Can not down cast. double to long. double value is " + value );
    }
  ...
  public float getFloat() throws IOException{
    if( value < Float.MIN_VALUE || Float.MAX_VALUE < value ){
      throw new NumberFormatException( "Can not down cast. double to float. double value is " + value );
    }
