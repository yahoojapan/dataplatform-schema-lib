...
public class IntegerObj implements PrimitiveObject{
  ...
  public byte getByte() throws IOException{
    if( value < Byte.MIN_VALUE || Byte.MAX_VALUE < value ){
      throw new NumberFormatException( "Can not down cast. long to byte. int value is " + value );
    }
  ...
  public short getShort() throws IOException{
    if( value < Short.MIN_VALUE || Short.MAX_VALUE < value ){
      throw new NumberFormatException( "Can not down cast. long to short. int value is " + value );
    }
