...
public class PrimitiveObjectContainer{
  ...
  private final Map<String,PrimitiveObject> primitiveContainer = new HashMap<String,PrimitiveObject>();
  ...
  public void register( final String varName , final PrimitiveObject primitiveObject ) throws IOException{
  ...
  public void set( final String varName , final byte[] data , final int start , final int length ) throws IOException{
