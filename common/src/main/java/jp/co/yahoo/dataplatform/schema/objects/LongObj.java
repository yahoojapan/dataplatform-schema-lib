...
public class LongObj implements PrimitiveObject{
  ...
  public byte getByte() throws IOException{
    if( value < Byte.MIN_VALUE || Byte.MAX_VALUE < value ){
      throw new NumberFormatException( "Can not down cast. long to byte. long value is " + value );
    }
  ...
  public short getShort() throws IOException{
    if( value < Short.MIN_VALUE || Short.MAX_VALUE < value ){
      throw new NumberFormatException( "Can not down cast. long to short. long value is " + value );
    }
  ...
  public int getInt() throws IOException{
    if( value < Integer.MIN_VALUE || Integer.MAX_VALUE < value ){
      throw new NumberFormatException( "Can not down cast. long to int. long value is " + value );
    }
