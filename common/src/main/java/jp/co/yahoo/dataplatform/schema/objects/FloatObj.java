...
public class FloatObj implements PrimitiveObject{
  ...
  public byte getByte() throws IOException{
    if( value < BYTE_MIN || BYTE_MAX < value ){
      throw new NumberFormatException( "Can not down cast. float to byte. float value is " + value );
    }
  ...
  public short getShort() throws IOException{
    if( value < SHORT_MIN || SHORT_MAX < value ){
      throw new NumberFormatException( "Can not down cast. float to short. float value is " + value );
    }
  ...
  public int getInt() throws IOException{
    if( value < INTEGER_MIN || INTEGER_MAX < value ){
      throw new NumberFormatException( "Can not down cast. float to int. float value is " + value );
    }
  ...
  public long getLong() throws IOException{
    if( value < LONG_MIN || LONG_MAX < value ){
      throw new NumberFormatException( "Can not down cast. float to long. float value is " + value );
    }
