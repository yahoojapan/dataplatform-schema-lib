...
import jp.co.yahoo.dataplatform.schema.objects.JavaObjectToPrimitiveObject;
import jp.co.yahoo.dataplatform.schema.objects.NullObj;
import jp.co.yahoo.dataplatform.schema.objects.PrimitiveObject;

public class JavaListParser implements IParser {

  private final List<Object> list;

  public JavaListParser( final List<Object> list ){
    this.list = list;
  }
  ...
  public PrimitiveObject get( final int index ) throws IOException{
    return JavaObjectToPrimitiveObject.get( list.get( index ) );
  }
  ...
  public IParser getParser( final int index ) throws IOException{
    return JavaParserFactory.get( list.get( index ) );
  }
